      ...
      {location.pathname == "/" || location.pathname == "/donation-centers" ? (
        <div className="header-container">
          ...
          <div className="links">
            ...
            <Link to="/donation-centers" className="link">
              Donation Centers
            </Link>
          </div>
          {user ? (
        ...
        <div className="header-container-dark">
          <div className="logo-dark">Dothes</div>
          <div className="links-dark">
            <Link to="/" className="link-dark">
              Home
            </Link>
            <Link to="/globe" className="link-dark">
              Explore
            </Link>
            <Link to="/donation-centers" className="link-dark">
              Donation Centers
            </Link>
          </div>
          {user ? (
            <div className="UserName-dark" onClick={logout}>
              Logout
            </div>
          ) : (
